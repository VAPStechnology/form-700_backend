...
//            userCredentials.put(email, "User ID: " + userId + ", Password: " + password);
//            System.out.println("User ID and Password for " + email + ": " + userId + ", " + password);
//            return "result";
//        } else {
//            return "invalid";
//        }
//    }
    ...
    public ResponseEntity<String> createUser(@RequestBody UserDto createUserRequest) {
        ...
        boolean otpSent = adminService.sendOTP(createUserRequest.getEmail(), createUserRequest.getMobileNumber(), otp);
        if (otpSent) {
